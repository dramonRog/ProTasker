...
namespace ProTasker.Controllers
{
    ...
    public class ProjectMembersController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<ProjectMemberResponse>>> GetAllMembers(CancellationToken cancellationToken)
        {
            var result = await _projectMemberService.GetAllAsync(cancellationToken);
